...
/**
 * Created by edominguez on 5/5/16.
 */
 ...
 */
    ...
    static void allocateOnDemand(IplImage img, CvSize size, int depth, int channels
        ...
        if (img == null) {
            System.out.println("Error: Couldn't allocate image. Out of memory?\n");
            return;
        }
    }
...
/* Create an object that decodes the input video stream. */
        CvCapture input_video = cvCaptureFromFile("./resources/video.avi");
        if (input_video == null) {
 /* Either the video didn't exist OR it uses a codec OpenCV
 * doesn't support.
 */
            System.out.println("Error: Can't open video.\n");
            return;
        }
 ...
 */
 ...
 /* Why did we get a null frame? We shouldn't be at the end. */
                System.out.println("Error: Hmm. The end came sooner than we thought.\n");
                return;
            }
 ...
 */
 ...
 /* Preparation: This array will contain the features found in frame 1. */
            opencv_core.CvPoint2D32f frame1_features[ 400];
 ...
 */
 ...
 /* This array will contain the locations of the points from frame 1 in frame 2. */
            opencv_core.CvPoint2D32f frame2_features[ 400];
 ...
 */
            opencv_core.CvTermCriteria optical_flow_termination_criteria = cvTermCriteria(CV_TERMCRIT_ITER | CV_TERMCRIT_EPS, 20, .3);
 ...
 */
                opencv_core.CvScalar line_color;
...
by a factor of 3.
 */
                CvPoint p = new CvPoint((int) frame1_features[i].x, (int) frame1_features[i].y);
                CvPoint q = new CvPoint((int) frame2_features[i].x, (int) frame2_features[i].y);

                double angle;
                angle = atan2((double) p.y() - q.y(), (double) p.x() - q.x());
                q.x
                double hypotenuse;
                hypotenuse = sqrt(Double.valueOf(Math.pow(p.y() - q.y(), 2) + Math.pow(p.x() - q.x(), 2)));
